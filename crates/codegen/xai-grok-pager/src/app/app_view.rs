...
impl AppView {
    ...
    /// App-level Esc owners that must win before the agent view handles Esc.
                ...
                if view_area.height > 0 {
                    match *active_view {
                        ActiveView::Welcome => {
                            ...
                            match welcome_mode {
                                Some((true, _, _)) => {
                                    flags_vec.push(crate::views::prompt_widget::PromptFlag {
                                        text: self
                                            .locale
                                            .named_static_text("mode.plan.label", "plan"),
                                ...
                                Some((false, false, true)) if welcome_auto_gate => {
                                    flags_vec.push(crate::views::prompt_widget::PromptFlag {
                                        text: self
                                            .locale
                                            .named_static_text("mode.auto.label", "auto"),
                            ...
                            let localized_hero_announcement =
                                hero_announcement.map(|announcement| {
                                    crate::views::welcome::localized_announcement_for_display(
                                        &self.locale,
                                        announcement,
                                        &self.announcement_translations,
                        ...
                        ActiveView::AgentDashboard => {
                            if let Some(dashboard) = self.dashboard.as_mut() {
                                ...
                                let dash_cursor =
                                    crate::views::dashboard::render_dashboard_with_locale(
                                        f.buffer_mut(),
                                        view_area,
                                        dashboard,
                                        agents,
