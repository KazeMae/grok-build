...
impl AgentCommand {
    ...
    pub fn display_name_with_locale(
        ...
        match self {
            ...
            Self::SwitchModelCompact => text("agent.command.switching_model", "Switching model"),
            ...
            Self::MemoryFlush => text("agent.command.flushing_memory", "Flushing memory"),
            Self::MemoryDream => text("agent.command.consolidating_memory", "Consolidating memory"),
        }
    }
