...
impl Default for TelemetryConfig {
    fn default() -> Self {
        // Privacy build: no baked or build-time product-telemetry endpoints.
...
mod tests {
    ...
    fn default_is_privacy_hard_off() {
        // Privacy build: product telemetry endpoints are never baked in and
        // runtime env overrides cannot resurrect the default sink.
