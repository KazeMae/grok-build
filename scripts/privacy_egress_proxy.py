...
Used by the privacy CI/egress smoke: run the release binary through this proxy
and assert no denylisted destinations appear. HTTPS traffic is not decrypted —
...
移植自 gork-build 0060-egress-guard（原样）。
"""
